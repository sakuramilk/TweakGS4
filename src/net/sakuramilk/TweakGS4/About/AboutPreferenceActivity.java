...
package net.sakuramilk.TweakGS4.About;
...
import net.sakuramilk.TweakGS4.General.SystemPropertySetting;
...
public class AboutPreferenceActivity extends PreferenceActivity
    ...
    public boolean onPreferenceClick(Preference preference)
    {
        if (preference == mReset) {
            ...
            Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=net.sakuramilk.TweakGS4");
